...
export const rotateHandleCircle: CSSProperties = {
    ...
    background: 'white', border: `2px solid ${tokens.colors.accentGreen}`,
...
export const coordsLabel: CSSProperties = {
    ...
    transform: 'translateX(-50%)', background: '#0d0d14',
...
export const contextMenu: CSSProperties = {
    position: 'fixed', background: '#0d0d14',
    border: '1px solid rgba(255,255,255,0.1)',
    borderRadius: '12px', padding: '8px',
    zIndex: 100000, display: 'flex', flexDirection: 'column',
    minWidth: '180px', boxShadow: tokens.shadows.card
};
