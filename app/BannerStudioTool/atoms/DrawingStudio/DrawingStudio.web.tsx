    ...
    return (
        <div style={styles.sidebar}>
                    ...
                    <>
                        <div style={styles.group}>
                            ...
                            <div style={styles.grid}>
                                ...
                                <ToolBtn active={tool==='pattern'} icon={patternImage ? <img src={patternImage} style={styles.toolPreviewImg} /> : <ImageIcon size={16}/>} onClick={()=>fileRef.current?.click()} title="Imagen" />
                                <input type="file" ref={fileRef} style={styles.hiddenInput} onChange={handlePatternUpload} accept="image/*" />
                            </div>
                        </div>
                        <div style={styles.group}>
            ...
            <div style={styles.footerActions}>
                <button onClick={handleFinalApply} style={styles.applyBtnElite}><Check size={14}/> GUARDAR</button>
                <button onClick={onCancel} style={styles.cancelBtnElite}><X size={14}/></button>
            </div>
        </div>
    );
};
...
export const DrawingCanvasLayer: React.FC<any> = ({ logic, width, height }) => {
    ...
    return (
        <div style={{...styles.drawingLayerWrapper, width: `${width}px`, height: `${height}px`}}>
